 ...
 * <li>SelectionButtons: 24 (One per ProductRack)</li>
 * <li>CoinSlot: Y</li>
 * <li>BillSlot: Y</li>
 * <li>CardSlot: Y</li>
 * <li>PayPal: Y</li>
...
public class VMRUS_TOC_C_MI extends AbstractVendingMachine{
	...
	public VMRUS_TOC_C_MI(Locale locale, int[] coinValues, int[] banknoteValues) {
		...
		rifffMachine = this.getRifffishLogger().createMachine(new Machine("That Vending Machine", "vmrus_toc_c_mi", "In Service", Currency.getInstance(this.getLocale()).getCurrencyCode()));
