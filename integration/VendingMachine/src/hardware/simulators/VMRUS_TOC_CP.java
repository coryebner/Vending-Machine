...
public class VMRUS_TOC_CP extends AbstractVendingMachine{
	...
	// CONSTRUCTOR
	public VMRUS_TOC_CP(Locale locale, int[] coinValues, int[] banknoteValues) {
		...
		rifffMachine = this.getRifffishLogger().createMachine(new Machine("That Vending Machine", "vmrus_toc_c_plus", "In Service", Currency.getInstance(this.getLocale()).getCurrencyCode()));
